...
customer_name_entry = tk.Entry(app)#Создаем поле для имени клиента для внесения в базу данных
...
#Создаем таблицу
columns = ("id", "customer_name", "order_details", "status")#Создаем кортеж
